...
public class SearchDaoTest
{
  ...
  public void testLimitSkip() throws Exception
  {
    ...
    int limit = -1;
    searchResults = dao.getTSystems(tenantName, verifiedSearchList, null, null, limit, DEFAULT_SORT_BY, DEFAULT_SORT_BY_DIRECTION, DEFAULT_SKIP, DEFAULT_START_AFTER);
    ...
    searchResults = dao.getTSystems(tenantName, verifiedSearchList, null, null, limit, DEFAULT_SORT_BY, DEFAULT_SORT_BY_DIRECTION, skip, DEFAULT_START_AFTER);
  ...
  public void testSortingSkip() throws Exception
  {
    ...
    sortBy = "name";
    sortDirection = "asc";
    searchResults = dao.getTSystems(tenantName, verifiedSearchList, null, null, DEFAULT_LIMIT, sortBy, sortDirection, DEFAULT_SKIP, DEFAULT_START_AFTER);
    assertEquals(searchResults.size(), numSystems, "Incorrect result count");
    checkOrder(searchResults, 1, numSystems);
    sortBy = "name";
    sortDirection = "desc";
    ...
    sortDirection = "asc";
    limit = 4;
    searchResults = dao.getTSystems(tenantName, verifiedSearchList, null, null, limit, sortBy, sortDirection, DEFAULT_SKIP, DEFAULT_START_AFTER);
    assertEquals(searchResults.size(), limit, "Incorrect result count");
    ...
    limit = 2;
    skip = 5;
    searchResults = dao.getTSystems(tenantName, verifiedSearchList, null, null, limit, sortBy, sortDirection, skip, DEFAULT_START_AFTER);
    assertEquals(searchResults.size(), limit, "Incorrect result count");
