...
public class SystemsDaoTest
{
  ...
  public void testGetSystems() throws Exception {
    ...
    int itemId = dao.createTSystem(authenticatedUser, sys0, gson.toJson(sys0), scrubbedJson);
    Assert.assertTrue(itemId > 0, "Invalid system id: " + itemId);
    List<TSystem> systems = dao.getTSystems(tenantName, null, null, null, DEFAULT_LIMIT, DEFAULT_SORT_BY,
                                            DEFAULT_SORT_BY_DIRECTION, DEFAULT_SKIP, DEFAULT_START_AFTER);
  ...
  public void testGetSystemsInIDList() throws Exception {
    ...
    List<TSystem> systems = dao.getTSystems(tenantName, null, null, idList, DEFAULT_LIMIT, DEFAULT_SORT_BY,
                                            DEFAULT_SORT_BY_DIRECTION, DEFAULT_SKIP, DEFAULT_START_AFTER);
    for (TSystem system : systems) {
      System.out.println("Found item with id: " + system.getId() + " and name: " + system.getName());
