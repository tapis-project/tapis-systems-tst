...
//    validCaseInputs.put(200,new CaseData(1, "name LIKE " + sysNameLikeAll, "job_local_archive_dir IN " + "noSuchDir," + escapedCommanInListValue));
  ...
  public void testLimitSkip() throws Exception
  {
    ...
    int limit = -1;
    searchResults = dao.getTSystems(tenantName, null, searchAST, null, limit, DEFAULT_SORTBY, DEFAULT_SORTBY_DIRECTION, DEFAULT_SKIP, DEFAULT_STARTAFTER, null);
    ...
    searchResults = dao.getTSystems(tenantName, null, searchAST, null, limit, DEFAULT_SORTBY, DEFAULT_SORTBY_DIRECTION, skip, DEFAULT_STARTAFTER, null);
  ...
  public void testSortingSkip() throws Exception
  {
    ...
    sortBy = "name";
    sortDirection = "asc";
    searchResults = dao.getTSystems(tenantName, null, searchAST, null, DEFAULT_LIMIT, sortBy, sortDirection, DEFAULT_SKIP, DEFAULT_STARTAFTER, null);
    assertEquals(searchResults.size(), numSystems, "Incorrect result count");
    checkOrder(searchResults, 1, numSystems);
    sortBy = "name";
    sortDirection = "desc";
    ...
    sortDirection = "asc";
    limit = 4;
    searchResults = dao.getTSystems(tenantName, null, searchAST, null, limit, sortBy, sortDirection, DEFAULT_SKIP, DEFAULT_STARTAFTER, null);
    assertEquals(searchResults.size(), limit, "Incorrect result count");
    ...
    limit = 2;
    skip = 5;
    searchResults = dao.getTSystems(tenantName, null, searchAST, null, limit, sortBy, sortDirection, skip, DEFAULT_STARTAFTER, null);
    assertEquals(searchResults.size(), limit, "Incorrect result count");
  ...
  public void testSortingStartAfter() throws Exception
  {
    ...
    searchResults = dao.getTSystems(tenantName, null, searchAST, null, limit, sortBy, sortDirection, DEFAULT_SKIP, startAfter, null);
    assertEquals(searchResults.size(), limit, "Incorrect result count");
    // Should get systems named SrchGet_006 to SrchGet_007
