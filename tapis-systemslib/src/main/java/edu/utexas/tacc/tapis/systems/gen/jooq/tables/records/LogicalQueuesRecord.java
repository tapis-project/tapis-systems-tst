...
public class LogicalQueuesRecord extends UpdatableRecordImpl<LogicalQueuesRecord> implements Record9<Integer, Integer, String, Integer, Integer, Integer, Integer, Integer, Integer> {

    private static final long serialVersionUID = 1610152300;
    ...
    @Override
    public LogicalQueuesRecord values(Integer value1, Integer value2, String value3, Integer value4, Integer value5, Integer value6, Integer value7, Integer value8, Integer value9) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LogicalQueuesRecord(Integer seqId, Integer systemSeqId, String name, Integer maxJobs, Integer maxJobsPerUser, Integer maxNodeCount, Integer maxCoresPerNode, Integer maxMemoryMb, Integer maxMinutes) {
        super(LogicalQueues.LOGICAL_QUEUES);
