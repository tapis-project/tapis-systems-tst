...
public class SystemUpdatesRecord extends UpdatableRecordImpl<SystemUpdatesRecord> implements Record10<Integer, Integer, String, String, String, String, SystemOperation, JsonElement, String, LocalDateTime> {

    private static final long serialVersionUID = 1835740142;
    ...
    @Override
    public Row10<Integer, Integer, String, String, String, String, SystemOperation, JsonElement, String, LocalDateTime> valuesRow() {
    ...
    @Override
    public SystemUpdatesRecord value10(LocalDateTime value) {
        setCreated(value);
        return this;
    }

    @Override
    public SystemUpdatesRecord values(Integer value1, Integer value2, String value3, String value4, String value5, String value6, SystemOperation value7, JsonElement value8, String value9, LocalDateTime value10) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SystemUpdatesRecord(Integer seqId, Integer systemSeqId, String systemTenant, String systemId, String userTenant, String userName, SystemOperation operation, JsonElement updJson, String updText, LocalDateTime created) {
        super(SystemUpdates.SYSTEM_UPDATES);
