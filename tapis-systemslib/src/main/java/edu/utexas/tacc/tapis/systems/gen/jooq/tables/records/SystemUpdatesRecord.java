...
public class SystemUpdatesRecord extends UpdatableRecordImpl<SystemUpdatesRecord> implements Record11<Integer, Integer, String, String, String, String, String, JsonElement, String, UUID, LocalDateTime> {

    private static final long serialVersionUID = 790950424;
    ...
    @Override
    public Row11<Integer, Integer, String, String, String, String, String, JsonElement, String, UUID, LocalDateTime> valuesRow() {
    ...
    @Override
    public SystemUpdatesRecord values(Integer value1, Integer value2, String value3, String value4, String value5, String value6, String value7, JsonElement value8, String value9, UUID value10, LocalDateTime value11) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public SystemUpdatesRecord(Integer seqId, Integer systemSeqId, String systemTenant, String systemId, String userTenant, String userName, String operation, JsonElement updJson, String updText, UUID uuid, LocalDateTime created) {
        super(SystemUpdates.SYSTEM_UPDATES);
