...
public class CapabilitiesRecord extends UpdatableRecordImpl<CapabilitiesRecord> implements Record8<Integer, Integer, Category, String, String, Datatype, Integer, String> {

    private static final long serialVersionUID = 198428573;
    ...
    @Override
    public Row8<Integer, Integer, Category, String, String, Datatype, Integer, String> valuesRow() {
    ...
    @Override
    public CapabilitiesRecord values(Integer value1, Integer value2, Category value3, String value4, String value5, Datatype value6, Integer value7, String value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CapabilitiesRecord(Integer seqId, Integer systemSeqId, Category category, String subcategory, String name, Datatype datatype, Integer precedence, String value) {
        super(Capabilities.CAPABILITIES);
