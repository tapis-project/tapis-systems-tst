...
public class CapabilitiesRecord extends UpdatableRecordImpl<CapabilitiesRecord> implements Record7<Integer, Integer, Category, String, String, Integer, String> {

    private static final long serialVersionUID = -1356683479;
    ...
    @Override
    public Row7<Integer, Integer, Category, String, String, Integer, String> fieldsRow() {
        return (Row7) super.fieldsRow();
    }

    @Override
    public Row7<Integer, Integer, Category, String, String, Integer, String> valuesRow() {
    ...
    @Override
    public CapabilitiesRecord values(Integer value1, Integer value2, Category value3, String value4, String value5, Integer value6, String value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public CapabilitiesRecord(Integer seqId, Integer systemSeqId, Category category, String name, String datatype, Integer precedence, String value) {
        super(Capabilities.CAPABILITIES);
