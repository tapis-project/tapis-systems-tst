...
public class Capabilities extends TableImpl<CapabilitiesRecord> {
    ...
    private static final long serialVersionUID = 1706151256;
     ...
     */
    public final TableField<CapabilitiesRecord, String> DATATYPE = createField(DSL.name("datatype"), org.jooq.impl.SQLDataType.CLOB.nullable(false), this, "Datatype associated with the value");
